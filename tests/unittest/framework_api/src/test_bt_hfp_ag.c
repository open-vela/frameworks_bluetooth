/****************************************************************************
 * tests/unittest/framework_api/src/test_bt_hfp_ag.c
 *
...
static bt_status_t mock_start_virtual_call(bt_address_t *a) { check_expected_ptr(a); return mock_type(bt_status_t); }
static bt_status_t mock_stop_virtual_call(bt_address_t *a) { check_expected_ptr(a); return mock_type(bt_status_t); }
...
static bt_status_t mock_send_at_command(bt_address_t *a, const char *cmd) { check_expected_ptr(a); return mock_type(bt_status_t); }
...
void test_bt_hfp_ag_register_callbacks_normal(FAR void **state)
{
    ...
    hfp_ag_callbacks_t cbs; memset(&cbs, 0, sizeof(cbs));
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x11);
    expect_any(mock_start_virtual_call, a); will_return(mock_start_virtual_call, BT_STATUS_SUCCESS);
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x22);
    expect_any(mock_start_virtual_call, a); will_return(mock_start_virtual_call, BT_STATUS_FAIL);
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x11);
    expect_any(mock_stop_virtual_call, a); will_return(mock_stop_virtual_call, BT_STATUS_SUCCESS);
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x22);
    expect_any(mock_stop_virtual_call, a); will_return(mock_stop_virtual_call, BT_STATUS_FAIL);
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x11);
    expect_any(mock_send_at_command, a); will_return(mock_send_at_command, BT_STATUS_SUCCESS);
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x22);
    expect_any(mock_send_at_command, a); will_return(mock_send_at_command, BT_STATUS_FAIL);
