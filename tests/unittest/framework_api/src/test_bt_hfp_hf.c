...
static bt_status_t mock_set_connection_policy(bt_address_t* a, connection_policy_t p)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
...
static bt_status_t mock_dial(bt_address_t* a, const char* n)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
static bt_status_t mock_dial_memory(bt_address_t* a, uint32_t m)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
static bt_status_t mock_redial(bt_address_t* a)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
static bt_status_t mock_accept_call(bt_address_t* a, hfp_call_accept_t f)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
static bt_status_t mock_reject_call(bt_address_t* a)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
static bt_status_t mock_hold_call(bt_address_t* a)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
static bt_status_t mock_terminate_call(bt_address_t* a)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
static bt_status_t mock_send_dtmf(bt_address_t* a, char d)
{
    check_expected_ptr(a);
    return mock_type(bt_status_t);
}
...
void test_bt_hfp_hf_set_connection_policy_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_set_connection_policy, a);
    will_return(mock_set_connection_policy, BT_STATUS_SUCCESS);
...
void test_bt_hfp_hf_set_connection_policy_fail(FAR void** state)
{
    ...
    ADDR_INIT(addr, 0x22);
    expect_any(mock_set_connection_policy, a);
    will_return(mock_set_connection_policy, BT_STATUS_FAIL);
...
void test_bt_hfp_hf_dial_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_dial, a);
    will_return(mock_dial, BT_STATUS_SUCCESS);
...
void test_bt_hfp_hf_dial_fail(FAR void** state)
{
    ...
    ADDR_INIT(addr, 0x22);
    expect_any(mock_dial, a);
    will_return(mock_dial, BT_STATUS_FAIL);
...
void test_bt_hfp_hf_dial_memory_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_dial_memory, a);
    will_return(mock_dial_memory, BT_STATUS_SUCCESS);
...
void test_bt_hfp_hf_dial_memory_fail(FAR void** state)
{
    ...
    ADDR_INIT(addr, 0x22);
    expect_any(mock_dial_memory, a);
    will_return(mock_dial_memory, BT_STATUS_FAIL);
...
void test_bt_hfp_hf_redial_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_redial, a);
    will_return(mock_redial, BT_STATUS_SUCCESS);
...
void test_bt_hfp_hf_redial_fail(FAR void** state)
{
    ...
    ADDR_INIT(addr, 0x22);
    expect_any(mock_redial, a);
    will_return(mock_redial, BT_STATUS_FAIL);
...
void test_bt_hfp_hf_accept_call_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_accept_call, a);
    will_return(mock_accept_call, BT_STATUS_SUCCESS);
...
void test_bt_hfp_hf_reject_call_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_reject_call, a);
    will_return(mock_reject_call, BT_STATUS_SUCCESS);
...
void test_bt_hfp_hf_hold_call_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_hold_call, a);
    will_return(mock_hold_call, BT_STATUS_SUCCESS);
...
void test_bt_hfp_hf_terminate_call_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_terminate_call, a);
    will_return(mock_terminate_call, BT_STATUS_SUCCESS);
...
void test_bt_hfp_hf_send_dtmf_normal(FAR void** state)
{
    bt_instance_t* ins = *state;
    ADDR_INIT(addr, 0x11);
    expect_any(mock_send_dtmf, a);
    will_return(mock_send_dtmf, BT_STATUS_SUCCESS);
