/****************************************************************************
 * tests/unittest/framework_api/src/test_bt_avrcp_target.c
 *
...
static bt_status_t mock_get_play_status_rsp(bt_address_t *a, avrcp_play_status_t ps, uint32_t sl, uint32_t sp) { check_expected_ptr(a); return mock_type(bt_status_t); }
static bt_status_t mock_play_status_notify(bt_address_t *a, avrcp_play_status_t ps) { check_expected_ptr(a); return mock_type(bt_status_t); }
...
void test_bt_avrcp_target_register_callbacks_normal(FAR void **state)
{
    ...
    avrcp_target_callbacks_t cbs; memset(&cbs, 0, sizeof(cbs));
...
void test_bt_avrcp_target_get_play_status_response_normal(FAR void **state)
{
    ...
    expect_any(mock_get_play_status_rsp, a); will_return(mock_get_play_status_rsp, BT_STATUS_SUCCESS);
...
void test_bt_avrcp_target_get_play_status_response_fail(FAR void **state)
{
    ...
    expect_any(mock_get_play_status_rsp, a); will_return(mock_get_play_status_rsp, BT_STATUS_FAIL);
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x11);
    expect_any(mock_play_status_notify, a); will_return(mock_play_status_notify, BT_STATUS_SUCCESS);
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x22);
    expect_any(mock_play_status_notify, a); will_return(mock_play_status_notify, BT_STATUS_FAIL);
...
{
    bt_instance_t *ins = *state; ADDR_INIT(addr, 0x33);
    expect_any(mock_get_play_status_rsp, a); will_return(mock_get_play_status_rsp, BT_STATUS_SUCCESS);
