/****************************************************************************
 * tests/unittest/framework_api/src/test_bt_pan.c
 *
...
static bt_status_t mock_connect(bt_address_t *a, uint8_t dst, uint8_t src) { check_expected_ptr(a); return mock_type(bt_status_t); }
...
void test_bt_pan_register_callbacks_normal(FAR void **state)
{
    ...
    pan_callbacks_t cbs; memset(&cbs, 0, sizeof(cbs));
