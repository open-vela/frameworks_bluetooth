...
{
    a2dp_sink_interface_t* p = (a2dp_sink_interface_t*)service_manager_get_profile(PROFILE_A2DP_SINK);
...
{
    a2dp_source_interface_t* p = (a2dp_source_interface_t*)service_manager_get_profile(PROFILE_A2DP);
    return p->register_callbacks(NULL, cbs);
}
...
{
    hfp_hf_interface_t* p = (hfp_hf_interface_t*)service_manager_get_profile(PROFILE_HFP_HF);
    return p->register_callbacks(NULL, cbs);
}
...
{
    hfp_ag_interface_t* p = (hfp_ag_interface_t*)service_manager_get_profile(PROFILE_HFP_AG);
    return p->register_callbacks(NULL, cbs);
}
...
{
    avrcp_control_interface_t* p = (avrcp_control_interface_t*)service_manager_get_profile(PROFILE_AVRCP_CT);
    return p->register_callbacks(NULL, cbs);
}
...
{
    avrcp_target_interface_t* p = (avrcp_target_interface_t*)service_manager_get_profile(PROFILE_AVRCP_TG);
    return p->register_callbacks(NULL, cbs);
}
...
{
    spp_interface_t* p = (spp_interface_t*)service_manager_get_profile(PROFILE_SPP);
...
{
    pan_interface_t* p = (pan_interface_t*)service_manager_get_profile(PROFILE_PANU);
    return p->register_callbacks(NULL, cbs);
}
...
{
    hid_device_interface_t* p = (hid_device_interface_t*)service_manager_get_profile(PROFILE_HID_DEV);
    return p->register_callbacks(NULL, cbs);
}
...
{
    gattc_interface_t* p = (gattc_interface_t*)service_manager_get_profile(PROFILE_GATTC);
...
{
    gatts_interface_t* p = (gatts_interface_t*)service_manager_get_profile(PROFILE_GATTS);
