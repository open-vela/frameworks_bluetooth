/****************************************************************************
 * tests/unittest/service_utils/src/test_btsnoop_filter.c
 *
...
void test_filter_set_flag_a2dp(FAR void **state)
{
    ...
    assert_true(g_snoop_filter.filter_items &
                (1ULL << BTSNOOP_FILTER_A2DP_AUDIO));
}
...
void test_filter_remove_flag_normal(FAR void **state)
{
    ...
    assert_int_equal(ret, 0);
    assert_false(g_snoop_filter.filter_items &
                 (1ULL << BTSNOOP_FILTER_A2DP_AUDIO));
}
