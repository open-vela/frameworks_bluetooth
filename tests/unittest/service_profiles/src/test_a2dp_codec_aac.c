/****************************************************************************
 * tests/unittest/service_profiles/src/test_a2dp_codec_aac.c
 *
...
/****************************************************************************
 * Block headers that pull in heavy external dependencies.
 * a2dp_codec_aac.c only needs a2dp_codec_aac.h (types + constants).
 ****************************************************************************/

#define __A2DP_CODEC_H__
#define __A2DP_SOURCE_AUDIO_H__

/* Include the AAC codec header directly for types */
