...
static void *list_allocator_calloc(size_t size);
static void list_allocator_free(void* ptr);
static list_node_t* list_free_node_(list_t* list, list_node_t* node);

static const allocator_t allocator_calloc = {list_allocator_calloc, list_allocator_free};
