...
#define CONFIG_BLUETOOTH_SERVICE_LOOP_THREAD_PRIORITY 100
...
#define CONFIG_BLUETOOTH_GATTS_MAX_ATTRIBUTE_NUM 16
...
#define CONFIG_BLUETOOTH_OBELISK 1
#define CONFIG_BLUETOOTH_SERVER 1
#define CONFIG_BLUETOOTH_SERVER_NAME "bluetoothd"
#define CONFIG_BLUETOOTH_IPC_JOIN_LOOP 1
//#define CONFIG_OBELISK_LOG_LEVEL 7
#define CONFIG_OBELISK_HCI_UART_NAME "/dev/ttyBT0"
#define CONFIG_OBELISK_LIBUV_LOOP 1
#define CONFIG_OBELISK_BREDR_BLUELET 1
#define CONFIG_OBELISK_LE_BLUELET 1
#define CONFIG_OBELISK_LE_SCAN_ENABLE 1
#define CONFIG_OBELISK_LE_SCANNER_MAX_NUM 2
#define CONFIG_OBELISK_LE_ADV_ENABLE 1
#define CONFIG_OBELISK_LE_ADVERTISER_MAX_NUM 2
#define CONFIG_BLUETOOTH_TOOLS 1
#define CONFIG_OBELISK_BT_VENDOR_BES 1

#define CONFIG_ANDROID_LOOPBACK 0x0A000202
