 ...
 ***************************************************************************/
#ifndef __BT_LEA_VMICPC_H__
#define __BT_LEA_VMICPC_H__
...
/**
 * @brief LE Audio vmicpc test callback
 *
 * @param cookie - callback cookie.
 */
typedef void (*lea_vmicpc_volume_state_callback)(void *cookie, bt_address_t *addr, int volume, int mute);
typedef void (*lea_vmicpc_volume_flags_callback)(void *cookie, bt_address_t *addr, int flags);
typedef void (*lea_vmicpc_mic_state_callback)(void *cookie, bt_address_t *addr, int mute);

typedef struct
{
    size_t size;
    lea_vmicpc_volume_state_callback volume_state_cb;
    lea_vmicpc_volume_flags_callback volume_flags_cb;
    lea_vmicpc_mic_state_callback mic_state_cb;
} lea_vmicpc_callbacks_t;

/**
 * @brief Register LE Audio vmicpc callback functions
 *
 * @param ins - bluetooth client instance.
 * @param callbacks - LE Audio vmicpc callback functions.
...
/**
 * @brief Unregister LE Audio vmicpc callback functions
 *
 * @param ins - bluetooth client instance.
 * @param cookie - callback cookie.
