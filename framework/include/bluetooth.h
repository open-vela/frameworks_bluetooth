...
/**
 * @brief IPC connected callback
 *
 * This function pointer is triggered as IPC connected.
 *
 * @param int - bluetooth instance.
...
/**
 * @brief IPC disconnected callback
 *
 * This function pointer is triggered as IPC disconnected.
 *
 * @param ins - bluetooth instance.
 * @param user_data - context data.
 * @param status - status of the IPC.
 * @return void.
 *
 * **Example:**
 * @code
static void ipc_connected(bt_instance_t* ins, void* userdata, int status)
{
