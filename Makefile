...
ifeq ($(findstring y, $(CONFIG_BLUETOOTH_AVRCP_TARGET)_$(CONFIG_BLUETOOTH_AVRCP_CONTROL)_$(CONFIG_BLUETOOTH_HFP_AG)_$(CONFIG_BLUETOOTH_HFP_HF)_$(CONFIG_BLUETOOTH_BLE_AUDIO)), )
