...
const char* bt_gattc_ipc_code_to_string(uint32_t code)
{
    switch (code) {
    CASE_RETURN_STR(BT_GATT_CLIENT_MESSAGE_START);
    CASE_RETURN_STR(BT_GATT_CLIENT_CREATE_CONNECT);
    CASE_RETURN_STR(BT_GATT_CLIENT_DELETE_CONNECT);
    CASE_RETURN_STR(BT_GATT_CLIENT_CONNECT);
    CASE_RETURN_STR(BT_GATT_CLIENT_DISCONNECT);
    CASE_RETURN_STR(BT_GATT_CLIENT_DISCOVER_SERVICE);
    CASE_RETURN_STR(BT_GATT_CLIENT_GET_ATTRIBUTE_BY_HANDLE);
    CASE_RETURN_STR(BT_GATT_CLIENT_GET_ATTRIBUTE_BY_UUID);
    CASE_RETURN_STR(BT_GATT_CLIENT_READ);
    CASE_RETURN_STR(BT_GATT_CLIENT_WRITE);
    CASE_RETURN_STR(BT_GATT_CLIENT_WRITE_NR);
    CASE_RETURN_STR(BT_GATT_CLIENT_SUBSCRIBE);
    CASE_RETURN_STR(BT_GATT_CLIENT_UNSUBSCRIBE);
    CASE_RETURN_STR(BT_GATT_CLIENT_EXCHANGE_MTU);
    CASE_RETURN_STR(BT_GATT_CLIENT_UPDATE_CONNECTION_PARAM);
    CASE_RETURN_STR(BT_GATT_CLIENT_READ_PHY);
    CASE_RETURN_STR(BT_GATT_CLIENT_UPDATE_PHY);
    CASE_RETURN_STR(BT_GATT_CLIENT_READ_RSSI);
    CASE_RETURN_STR(BT_GATT_CLIENT_MESSAGE_END);
    CASE_RETURN_STR(BT_GATT_CLIENT_CALLBACK_START);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_CONNECTED);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_DISCONNECTED);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_DISCOVERED);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_MTU_UPDATED);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_READ);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_WRITTEN);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_SUBSCRIBED);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_NOTIFIED);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_PHY_READ);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_PHY_UPDATED);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_RSSI_READ);
    CASE_RETURN_STR(BT_GATT_CLIENT_ON_CONN_PARAM_UPDATED);
    CASE_RETURN_STR(BT_GATT_CLIENT_CALLBACK_END);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_GATTC_BEGIN);
    CASE_RETURN_STR(BT_GATT_CLIENT_WRITE_WITH_SIGNED);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_GATTC_END);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_GATTC_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_GATTC_END);
    default:
        return NULL;
    }
}
