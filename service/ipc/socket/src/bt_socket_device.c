...
const char* bt_device_ipc_code_to_string(uint32_t code)
{
    switch (code) {
    CASE_RETURN_STR(BT_DEVICE_MESSAGE_START);
    CASE_RETURN_STR(BT_DEVICE_GET_IDENTITY_ADDRESS);
    CASE_RETURN_STR(BT_DEVICE_GET_ADDRESS_TYPE);
    CASE_RETURN_STR(BT_DEVICE_GET_DEVICE_TYPE);
    CASE_RETURN_STR(BT_DEVICE_GET_NAME);
    CASE_RETURN_STR(BT_DEVICE_GET_DEVICE_CLASS);
    CASE_RETURN_STR(BT_DEVICE_GET_UUIDS);
    CASE_RETURN_STR(BT_DEVICE_GET_APPEARANCE);
    CASE_RETURN_STR(BT_DEVICE_GET_RSSI);
    CASE_RETURN_STR(BT_DEVICE_GET_ALIAS);
    CASE_RETURN_STR(BT_DEVICE_SET_ALIAS);
    CASE_RETURN_STR(BT_DEVICE_IS_CONNECTED);
    CASE_RETURN_STR(BT_DEVICE_IS_ENCRYPTED);
    CASE_RETURN_STR(BT_DEVICE_IS_BOND_INITIATE_LOCAL);
    CASE_RETURN_STR(BT_DEVICE_GET_BOND_STATE);
    CASE_RETURN_STR(BT_DEVICE_IS_BONDED);
    CASE_RETURN_STR(BT_DEVICE_CREATE_BOND);
    CASE_RETURN_STR(BT_DEVICE_REMOVE_BOND);
    CASE_RETURN_STR(BT_DEVICE_CANCEL_BOND);
    CASE_RETURN_STR(BT_DEVICE_PAIR_REQUEST_REPLY);
    CASE_RETURN_STR(BT_DEVICE_SET_PAIRING_CONFIRMATION);
    CASE_RETURN_STR(BT_DEVICE_SET_PIN_CODE);
    CASE_RETURN_STR(BT_DEVICE_SET_PASS_KEY);
    CASE_RETURN_STR(BT_DEVICE_SET_LE_LEGACY_TK);
    CASE_RETURN_STR(BT_DEVICE_SET_LE_SC_REMOTE_OOB_DATA);
    CASE_RETURN_STR(BT_DEVICE_GET_LE_SC_LOCAL_OOB_DATA);
    CASE_RETURN_STR(BT_DEVICE_CONNECT);
    CASE_RETURN_STR(BT_DEVICE_BACKGROUND_CONNECT);
    CASE_RETURN_STR(BT_DEVICE_DISCONNECT);
    CASE_RETURN_STR(BT_DEVICE_BACKGROUND_DISCONNECT);
    CASE_RETURN_STR(BT_DEVICE_CONNECT_LE);
    CASE_RETURN_STR(BT_DEVICE_DISCONNECT_LE);
    CASE_RETURN_STR(BT_DEVICE_CONNECT_REQUEST_REPLY);
    CASE_RETURN_STR(BT_DEVICE_SET_LE_PHY);
    CASE_RETURN_STR(BT_DEVICE_CONNECT_ALL_PROFILE);
    CASE_RETURN_STR(BT_DEVICE_DISCONNECT_ALL_PROFILE);
    CASE_RETURN_STR(BT_DEVICE_ENABLE_ENHANCED_MODE);
    CASE_RETURN_STR(BT_DEVICE_DISABLE_ENHANCED_MODE);
    CASE_RETURN_STR(BT_DEVICE_MESSAGE_END);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_DEVICE_BEGIN);
    CASE_RETURN_STR(BT_DEVICE_SET_SECURITY_LEVEL);
    CASE_RETURN_STR(BT_DEVICE_SET_BONDABLE_LE);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_DEVICE_END);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_DEVICE_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_DEVICE_END);
    default:
        return NULL;
    }
}
