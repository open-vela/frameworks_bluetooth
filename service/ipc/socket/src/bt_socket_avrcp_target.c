...
const char* bt_avrcp_target_ipc_code_to_string(uint32_t code)
{
    switch (code) {
    CASE_RETURN_STR(BT_AVRCP_TARGET_MESSAGE_START);
    CASE_RETURN_STR(BT_AVRCP_TARGET_REGISTER_CALLBACKS);
    CASE_RETURN_STR(BT_AVRCP_TARGET_UNREGISTER_CALLBACKS);
    CASE_RETURN_STR(BT_AVRCP_TARGET_GET_PLAY_STATUS_RESPONSE);
    CASE_RETURN_STR(BT_AVRCP_TARGET_PLAY_STATUS_NOTIFY);
    CASE_RETURN_STR(BT_AVRCP_TARGET_MESSAGE_END);
    CASE_RETURN_STR(BT_AVRCP_TARGET_CALLBACK_START);
    CASE_RETURN_STR(BT_AVRCP_TARGET_ON_CONNECTION_STATE_CHANGED);
    CASE_RETURN_STR(BT_AVRCP_TARGET_ON_GET_PLAY_STATUS_REQUEST);
    CASE_RETURN_STR(BT_AVRCP_TARGET_ON_REGISTER_NOTIFICATION_REQUEST);
    CASE_RETURN_STR(BT_AVRCP_TARGET_ON_PANEL_OPERATION_RECEIVED);
    CASE_RETURN_STR(BT_AVRCP_TARGET_CALLBACK_END);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_AVRCP_TG_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_AVRCP_TG_END);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_AVRCP_TG_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_AVRCP_TG_END);
    default:
        return NULL;
    }
}
