...
{
    switch (code) {
    CASE_RETURN_STR(BT_AVRCP_CONTROL_MESSAGE_START);
    CASE_RETURN_STR(BT_AVRCP_CONTROL_REGISTER_CALLBACKS);
    CASE_RETURN_STR(BT_AVRCP_CONTROL_UNREGISTER_CALLBACKS);
    CASE_RETURN_STR(BT_AVRCP_CONTROL_GET_ELEMENT_ATTRIBUTES);
    CASE_RETURN_STR(BT_AVRCP_CONTROL_MESSAGE_END);
    CASE_RETURN_STR(BT_AVRCP_CONTROL_CALLBACK_START);
    CASE_RETURN_STR(BT_AVRCP_CONTROL_ON_CONNECTION_STATE_CHANGED);
    CASE_RETURN_STR(BT_AVRCP_CONTROL_ON_GET_ELEMENT_ATTRIBUTES_REQUEST);
    CASE_RETURN_STR(BT_AVRCP_CONTROL_CALLBACK_END);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_AVRCP_CT_BEGIN);
    CASE_RETURN_STR(BT_AVRCP_CT_SEND_PASSTHROUGH_CMD);
    CASE_RETURN_STR(BT_AVRCP_CT_GET_UNIT_INFO_CMD);
    CASE_RETURN_STR(BT_AVRCP_CT_GET_SUBUNIT_INFO_CMD);
    CASE_RETURN_STR(BT_AVRCP_CT_GET_PLAYBACK_STATE_CMD);
    CASE_RETURN_STR(BT_AVRCP_CT_REGISTER_NOTIFICATION_CMD);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_AVRCP_CT_END);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_AVRCP_CT_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_AVRCP_CT_END);
    default:
        return NULL;
    }
}
