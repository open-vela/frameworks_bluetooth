...
const char* bt_hfp_hf_ipc_code_to_string(uint32_t code)
{
    switch (code) {
    CASE_RETURN_STR(BT_HFP_HF_MESSAGE_START);
    CASE_RETURN_STR(BT_HFP_HF_REGISTER_CALLBACK);
    CASE_RETURN_STR(BT_HFP_HF_UNREGISTER_CALLBACK);
    CASE_RETURN_STR(BT_HFP_HF_IS_CONNECTED);
    CASE_RETURN_STR(BT_HFP_HF_IS_AUDIO_CONNECTED);
    CASE_RETURN_STR(BT_HFP_HF_GET_CONNECTION_STATE);
    CASE_RETURN_STR(BT_HFP_HF_CONNECT);
    CASE_RETURN_STR(BT_HFP_HF_SET_CONNECTION_POLICY);
    CASE_RETURN_STR(BT_HFP_HF_DISCONNECT);
    CASE_RETURN_STR(BT_HFP_HF_CONNECT_AUDIO);
    CASE_RETURN_STR(BT_HFP_HF_DISCONNECT_AUDIO);
    CASE_RETURN_STR(BT_HFP_HF_START_VOICE_RECOGNITION);
    CASE_RETURN_STR(BT_HFP_HF_STOP_VOICE_RECOGNITION);
    CASE_RETURN_STR(BT_HFP_HF_DIAL);
    CASE_RETURN_STR(BT_HFP_HF_DIAL_MEMORY);
    CASE_RETURN_STR(BT_HFP_HF_REDIAL);
    CASE_RETURN_STR(BT_HFP_HF_ACCEPT_CALL);
    CASE_RETURN_STR(BT_HFP_HF_REJECT_CALL);
    CASE_RETURN_STR(BT_HFP_HF_HOLD_CALL);
    CASE_RETURN_STR(BT_HFP_HF_TERMINATE_CALL);
    CASE_RETURN_STR(BT_HFP_HF_CONTROL_CALL);
    CASE_RETURN_STR(BT_HFP_HF_QUERY_CURRENT_CALLS);
    CASE_RETURN_STR(BT_HFP_HF_SEND_AT_CMD);
    CASE_RETURN_STR(BT_HFP_HF_UPDATE_BATTERY_LEVEL);
    CASE_RETURN_STR(BT_HFP_HF_VOLUME_CONTROL);
    CASE_RETURN_STR(BT_HFP_HF_SEND_DTMF);
    CASE_RETURN_STR(BT_HFP_HF_MESSAGE_END);
    CASE_RETURN_STR(BT_HFP_HF_CALLBACK_START);
    CASE_RETURN_STR(BT_HFP_HF_ON_CONNECTION_STATE_CHANGED);
    CASE_RETURN_STR(BT_HFP_HF_ON_AUDIO_STATE_CHANGED);
    CASE_RETURN_STR(BT_HFP_HF_ON_VOICE_RECOGNITION_STATE_CHANGED);
    CASE_RETURN_STR(BT_HFP_HF_ON_CALL_STATE_CHANGED);
    CASE_RETURN_STR(BT_HFP_HF_ON_AT_CMD_COMPLETE);
    CASE_RETURN_STR(BT_HFP_HF_ON_RING_INDICATION);
    CASE_RETURN_STR(BT_HFP_HF_ON_VOLUME_CHANGED);
    CASE_RETURN_STR(BT_HFP_HF_ON_CALL_IND_RECEIVED);
    CASE_RETURN_STR(BT_HFP_HF_ON_CALLSETUP_IND_RECEIVED);
    CASE_RETURN_STR(BT_HFP_HF_ON_CALLHELD_IND_RECEIVED);
    CASE_RETURN_STR(BT_HFP_HF_CALLBACK_END);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_HFP_HF_BEGIN);
    CASE_RETURN_STR(BT_HFP_HF_GET_SUBSCRIBER_NUMBER);
    CASE_RETURN_STR(BT_HFP_HF_QUERY_CURRENT_CALLS_WITH_CALLBACK);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_HFP_HF_END);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_HFP_HF_BEGIN);
    CASE_RETURN_STR(BT_HFP_HF_ON_CLIP_RECEIVED);
    CASE_RETURN_STR(BT_HFP_HF_ON_SUBSCRIBER_NUMBER_RECEIVED);
    CASE_RETURN_STR(BT_HFP_HF_ON_CURRENT_CALLS);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_HFP_HF_END);
    default:
        return NULL;
    }
}
