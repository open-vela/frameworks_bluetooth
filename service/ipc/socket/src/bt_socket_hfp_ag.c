...
{
    switch (code) {
    CASE_RETURN_STR(BT_HFP_AG_MESSAGE_START);
    CASE_RETURN_STR(BT_HFP_AG_REGISTER_CALLBACK);
    CASE_RETURN_STR(BT_HFP_AG_UNREGISTER_CALLBACK);
    CASE_RETURN_STR(BT_HFP_AG_IS_CONNECTED);
    CASE_RETURN_STR(BT_HFP_AG_IS_AUDIO_CONNECTED);
    CASE_RETURN_STR(BT_HFP_AG_GET_CONNECTION_STATE);
    CASE_RETURN_STR(BT_HFP_AG_CONNECT);
    CASE_RETURN_STR(BT_HFP_AG_DISCONNECT);
    CASE_RETURN_STR(BT_HFP_AG_CONNECT_AUDIO);
    CASE_RETURN_STR(BT_HFP_AG_DISCONNECT_AUDIO);
    CASE_RETURN_STR(BT_HFP_AG_START_VIRTUAL_CALL);
    CASE_RETURN_STR(BT_HFP_AG_STOP_VIRTUAL_CALL);
    CASE_RETURN_STR(BT_HFP_AG_START_VOICE_RECOGNITION);
    CASE_RETURN_STR(BT_HFP_AG_STOP_VOICE_RECOGNITION);
    CASE_RETURN_STR(BT_HFP_AG_PHONE_STATE_CHANGE);
    CASE_RETURN_STR(BT_HFP_AG_NOTIFY_DEVICE_STATUS);
    CASE_RETURN_STR(BT_HFP_AG_VOLUME_CONTROL);
    CASE_RETURN_STR(BT_HFP_AG_SEND_AT_COMMAND);
    CASE_RETURN_STR(BT_HFP_AG_SEND_VENDOR_SPECIFIC_AT_COMMAND);
    CASE_RETURN_STR(BT_HFP_AG_SEND_CLCC_RESPONSE);
    CASE_RETURN_STR(BT_HFP_AG_MESSAGE_END);
    CASE_RETURN_STR(BT_HFP_AG_CALLBACK_START);
    CASE_RETURN_STR(BT_HFP_AG_ON_CONNECTION_STATE_CHANGED);
    CASE_RETURN_STR(BT_HFP_AG_ON_AUDIO_STATE_CHANGED);
    CASE_RETURN_STR(BT_HFP_AG_ON_VOICE_RECOGNITION_STATE_CHANGED);
    CASE_RETURN_STR(BT_HFP_AG_ON_BATTERY_LEVEL_CHANGED);
    CASE_RETURN_STR(BT_HFP_AG_ON_VOLUME_CONTROL);
    CASE_RETURN_STR(BT_HFP_AG_ON_ANSWER_CALL);
    CASE_RETURN_STR(BT_HFP_AG_ON_REJECT_CALL);
    CASE_RETURN_STR(BT_HFP_AG_ON_HANGUP_CALL);
    CASE_RETURN_STR(BT_HFP_AG_ON_DIAL_CALL);
    CASE_RETURN_STR(BT_HFP_AG_ON_AT_COMMAND_RECEIVED);
    CASE_RETURN_STR(BT_HFP_AG_ON_VENDOR_SPECIFIC_AT_COMMAND_RECEIVED);
    CASE_RETURN_STR(BT_HFP_AG_ON_CLCC_COMMAND_RECEIVED);
    CASE_RETURN_STR(BT_HFP_AG_CALLBACK_END);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_HFP_AG_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_HFP_AG_END);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_HFP_AG_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_HFP_AG_END);
    default:
        return NULL;
    }
}
