...
{
    switch (code) {
    CASE_RETURN_STR(BT_GATT_SERVER_MESSAGE_START);
    CASE_RETURN_STR(BT_GATT_SERVER_REGISTER_SERVICE);
    CASE_RETURN_STR(BT_GATT_SERVER_UNREGISTER_SERVICE);
    CASE_RETURN_STR(BT_GATT_SERVER_CONNECT);
    CASE_RETURN_STR(BT_GATT_SERVER_DISCONNECT);
    CASE_RETURN_STR(BT_GATT_SERVER_ADD_ATTR_TABLE);
    CASE_RETURN_STR(BT_GATT_SERVER_REMOVE_ATTR_TABLE);
    CASE_RETURN_STR(BT_GATT_SERVER_SET_ATTR_VALUE);
    CASE_RETURN_STR(BT_GATT_SERVER_GET_ATTR_VALUE);
    CASE_RETURN_STR(BT_GATT_SERVER_RESPONSE);
    CASE_RETURN_STR(BT_GATT_SERVER_NOTIFY);
    CASE_RETURN_STR(BT_GATT_SERVER_INDICATE);
    CASE_RETURN_STR(BT_GATT_SERVER_READ_PHY);
    CASE_RETURN_STR(BT_GATT_SERVER_UPDATE_PHY);
    CASE_RETURN_STR(BT_GATT_SERVER_MESSAGE_END);
    CASE_RETURN_STR(BT_GATT_SERVER_CALLBACK_START);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_CONNECTED);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_DISCONNECTED);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_ATTR_TABLE_ADDED);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_ATTR_TABLE_REMOVED);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_MTU_CHANGED);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_READ_REQUEST);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_WRITE_REQUEST);
    CASE_RETURN_STR(BT_GATT_SERVER_NOTIFY_COMPLETE);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_PHY_READ);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_PHY_UPDATED);
    CASE_RETURN_STR(BT_GATT_SERVER_ON_CONN_PARAM_CHANGED);
    CASE_RETURN_STR(BT_GATT_SERVER_CALLBACK_END);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_GATTS_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_GATTS_END);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_GATTS_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_GATTS_END);
    default:
        return NULL;
    }
}
