...
const char* bt_adapter_ipc_code_to_string(uint32_t code)
{
    switch (code) {
    CASE_RETURN_STR(BT_ADAPTER_MESSAGE_START);
    CASE_RETURN_STR(BT_ADAPTER_ENABLE);
    CASE_RETURN_STR(BT_ADAPTER_DISABLE);
    CASE_RETURN_STR(BT_ADAPTER_DISABLE_SAFE);
    CASE_RETURN_STR(BT_ADAPTER_ENABLE_LE);
    CASE_RETURN_STR(BT_ADAPTER_DISABLE_LE);
    CASE_RETURN_STR(BT_ADAPTER_GET_STATE);
    CASE_RETURN_STR(BT_ADAPTER_GET_TYPE);
    CASE_RETURN_STR(BT_ADAPTER_SET_DISCOVERY_FILTER);
    CASE_RETURN_STR(BT_ADAPTER_START_DISCOVERY);
    CASE_RETURN_STR(BT_ADAPTER_CANCEL_DISCOVERY);
    CASE_RETURN_STR(BT_ADAPTER_IS_DISCOVERING);
    CASE_RETURN_STR(BT_ADAPTER_GET_ADDRESS);
    CASE_RETURN_STR(BT_ADAPTER_SET_NAME);
    CASE_RETURN_STR(BT_ADAPTER_GET_NAME);
    CASE_RETURN_STR(BT_ADAPTER_GET_UUIDS);
    CASE_RETURN_STR(BT_ADAPTER_SET_SCAN_MODE);
    CASE_RETURN_STR(BT_ADAPTER_GET_SCAN_MODE);
    CASE_RETURN_STR(BT_ADAPTER_SET_DEVICE_CLASS);
    CASE_RETURN_STR(BT_ADAPTER_GET_DEVICE_CLASS);
    CASE_RETURN_STR(BT_ADAPTER_SET_IO_CAPABILITY);
    CASE_RETURN_STR(BT_ADAPTER_GET_IO_CAPABILITY);
    CASE_RETURN_STR(BT_ADAPTER_SET_INQUIRY_SCAN_PARAMETERS);
    CASE_RETURN_STR(BT_ADAPTER_SET_PAGE_SCAN_PARAMETERS);
    CASE_RETURN_STR(BT_ADAPTER_GET_BONDED_DEVICES);
    CASE_RETURN_STR(BT_ADAPTER_GET_CONNECTED_DEVICES);
    CASE_RETURN_STR(BT_ADAPTER_DISCONNECT_ALL_DEVICES);
    CASE_RETURN_STR(BT_ADAPTER_IS_SUPPORT_BREDR);
    CASE_RETURN_STR(BT_ADAPTER_REGISTER_CALLBACK);
    CASE_RETURN_STR(BT_ADAPTER_UNREGISTER_CALLBACK);
    CASE_RETURN_STR(BT_ADAPTER_IS_LE_ENABLED);
    CASE_RETURN_STR(BT_ADAPTER_IS_SUPPORT_LE);
    CASE_RETURN_STR(BT_ADAPTER_IS_SUPPORT_LEAUDIO);
    CASE_RETURN_STR(BT_ADAPTER_GET_LE_ADDRESS);
    CASE_RETURN_STR(BT_ADAPTER_SET_LE_ADDRESS);
    CASE_RETURN_STR(BT_ADAPTER_SET_LE_IDENTITY_ADDRESS);
    CASE_RETURN_STR(BT_ADAPTER_SET_LE_IO_CAPABILITY);
    CASE_RETURN_STR(BT_ADAPTER_GET_LE_IO_CAPABILITY);
    CASE_RETURN_STR(BT_ADAPTER_SET_LE_APPEARANCE);
    CASE_RETURN_STR(BT_ADAPTER_GET_LE_APPEARANCE);
    CASE_RETURN_STR(BT_ADAPTER_LE_ENABLE_KEY_DERIVATION);
    CASE_RETURN_STR(BT_ADAPTER_LE_ADD_WHITELIST);
    CASE_RETURN_STR(BT_ADAPTER_LE_REMOVE_WHITELIST);
    CASE_RETURN_STR(BT_ADAPTER_SET_AFH_CHANNEL_CLASSFICATION);
    CASE_RETURN_STR(BT_ADAPTER_MESSAGE_END);
    CASE_RETURN_STR(BT_ADAPTER_CALLBACK_START);
    CASE_RETURN_STR(BT_ADAPTER_ON_ADAPTER_STATE_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_DISCOVERY_STATE_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_DISCOVERY_RESULT);
    CASE_RETURN_STR(BT_ADAPTER_ON_SCAN_MODE_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_DEVICE_NAME_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_PAIR_REQUEST);
    CASE_RETURN_STR(BT_ADAPTER_ON_PAIR_DISPLAY);
    CASE_RETURN_STR(BT_ADAPTER_ON_CONNECT_REQUEST);
    CASE_RETURN_STR(BT_ADAPTER_ON_CONNECTION_STATE_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_BOND_STATE_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_LE_SC_LOCAL_OOB_DATA_GOT);
    CASE_RETURN_STR(BT_ADAPTER_ON_REMOTE_NAME_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_REMOTE_ALIAS_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_REMOTE_COD_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_ON_REMOTE_UUIDS_CHANGED);
    CASE_RETURN_STR(BT_ADAPTER_CALLBACK_END);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_ADAPTER_BEGIN);
    CASE_RETURN_STR(BT_ADAPTER_START_LIMITED_DISCOVERY);
    CASE_RETURN_STR(BT_ADAPTER_SET_DEBUG_MODE);
    CASE_RETURN_STR(BT_IPC_CODE_COMMAND_ADAPTER_END);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_ADAPTER_BEGIN);
    CASE_RETURN_STR(BT_IPC_CODE_CALLBACK_ADAPTER_END);
    default:
        return NULL;
    }
}
