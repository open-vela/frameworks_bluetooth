...
#define BT_IPC_CODE_GROUP_PA (8)
#define BT_IPC_CODE_GROUP_PA_SYNC (9)
...
#define BT_IPC_CODE_GROUP_LEAUDIO_VMICP (BT_IPC_CODE_GROUP_PROFILES + PROFILE_LEAUDIO_VMICP)
#define BT_IPC_CODE_GROUP_AURACAST_SOURCE (BT_IPC_CODE_GROUP_PROFILES + PROFILE_AURACAST_SOURCE)
#define BT_IPC_CODE_GROUP_AURACAST_SINK (BT_IPC_CODE_GROUP_PROFILES + PROFILE_AURACAST_SINK)
