...
#define PA_SYNC_SUBCODE_AURACAST_READY_CALLBACK 4
...
#define BT_PA_SYNC_ON_AURACAST_READY BT_IPC_CODE(BT_IPC_CODE_TYPE_CALLBACK, BT_IPC_CODE_GROUP_PA_SYNC, PA_SYNC_SUBCODE_AURACAST_READY_CALLBACK)
