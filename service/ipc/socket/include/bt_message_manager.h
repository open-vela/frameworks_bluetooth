...
#define BT_IPC_CODE_COMMAND_MANAGER_BEGIN BT_IPC_CODE(BT_IPC_CODE_TYPE_COMMAND, BT_IPC_CODE_GROUP_MANAGER, 0)
// TODO: Add new BT IPC Code sequentially
#define BT_IPC_CODE_COMMAND_MANAGER_END BT_IPC_CODE(BT_IPC_CODE_TYPE_COMMAND, BT_IPC_CODE_GROUP_MANAGER, BT_IPC_CODE_SUBCODE_MAX_NUM)

#define BT_IPC_CODE_CALLBACK_MANAGER_BEGIN BT_IPC_CODE(BT_IPC_CODE_TYPE_CALLBACK, BT_IPC_CODE_GROUP_MANAGER, 0)
// TODO: Add new BT IPC Code sequentially
#define BT_IPC_CODE_CALLBACK_MANAGER_END BT_IPC_CODE(BT_IPC_CODE_TYPE_CALLBACK, BT_IPC_CODE_GROUP_MANAGER, BT_IPC_CODE_SUBCODE_MAX_NUM)
