...
#define BT_IPC_CODE_COMMAND_HID_DEV_END BT_IPC_CODE(BT_IPC_CODE_TYPE_COMMAND, BT_IPC_CODE_GROUP_HID_DEV, BT_IPC_CODE_SUBCODE_MAX_NUM)

#define BT_IPC_CODE_CALLBACK_HID_DEV_BEGIN BT_IPC_CODE(BT_IPC_CODE_TYPE_CALLBACK, BT_IPC_CODE_GROUP_HID_DEV, 0)
// TODO: Add new BT IPC Code sequentially
