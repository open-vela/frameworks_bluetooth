...
#define L2CAP_SUBCODE_BR_DISCONNECT 5
...
#define BT_L2CAP_BR_DISCONNECT BT_IPC_CODE(BT_IPC_CODE_TYPE_COMMAND, BT_IPC_CODE_GROUP_L2CAP, L2CAP_SUBCODE_BR_DISCONNECT)
