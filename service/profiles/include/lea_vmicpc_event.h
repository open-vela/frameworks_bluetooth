 ...
 ***************************************************************************/
#ifndef __LEA_VMICPC_EVENT_H__
#define __LEA_VMICPC_EVENT_H__
...
typedef struct {
    ...
    lea_vmicpc_event_t event;
    union {
        bts_vmicpc_vol_state_s vol_state;
        uint8_t vol_flags;
