 ...
 ***************************************************************************/
#ifndef __LEA_VMICPC_SERVICE_H__
#define __LEA_VMICPC_SERVICE_H__
...
typedef struct {
    ...
    void *(*register_callbacks)(void *handle, lea_vmicpc_callbacks_t *callbacks);
    bool (*unregister_callbacks)(void **handle, void *cookie);
} lea_vmicpc_interface_t;
...
#endif /* __LEA_VMICPC_SERVICE_H__ */
