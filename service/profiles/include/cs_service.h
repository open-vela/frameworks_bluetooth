...
typedef enum {
	BT_LE_SRV_CS_SUBEVENT_COMPLETE = 0x1,
	BT_LE_SRV_CS_SUBEVENT_ABORTED = 0xF,
...
typedef struct {
    ...
    bt_status_t (*subevent_result_callbacks)(bt_address_t* addr, void* data);
