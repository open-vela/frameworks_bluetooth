...
#undef BT_FW_UUID_DECLARE_32
#undef BT_FW_UUID_DECLARE_128
...
static uint8_t sal_op_2_zephyr_op(avrcp_passthr_cmd_t op)
{
    ...
    case PASSTHROUGH_CMD_ID_EJECT:
        return AVRCP_OPERATION_ID_EJECT;
    ...
    case PASSTHROUGH_CMD_ID_ANGLE:
        return AVRCP_OPERATION_ID_ANGLE;
    case PASSTHROUGH_CMD_ID_SUBPICTURE:
        return AVRCP_OPERATION_ID_SUBPICTURE;
    case PASSTHROUGH_CMD_ID_F1:
        return AVRCP_OPERATION_ID_F1;
    case PASSTHROUGH_CMD_ID_F2:
        return AVRCP_OPERATION_ID_F2;
    case PASSTHROUGH_CMD_ID_F3:
        return AVRCP_OPERATION_ID_F3;
    case PASSTHROUGH_CMD_ID_F4:
        return AVRCP_OPERATION_ID_F4;
    case PASSTHROUGH_CMD_ID_F5:
        return AVRCP_OPERATION_ID_F5;
    case PASSTHROUGH_CMD_ID_VENDOR_UNIQUE:
        return AVRCP_OPERATION_ID_VENDOR_UNIQUE;
    ...
    bt_address_t* bd_addr)
{
    ...
    SAL_CHECK_RET_WITH_CONN(bt_avrcp_ct_get_subunit_info(conn), 0, conn);
