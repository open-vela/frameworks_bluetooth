...
typedef struct {
   ...
   */
    bt_result_code (*init)(void* handle, bt_a2dp_source_callbacks_t* callbacks, bt_a2dp_stream_config_t stream_config);
    ...
    bt_result_code (*config_codec)(void* handle, const bt_address address, bt_a2dp_stream_config_t streamConfig);
