...
static gatt_attr_db_t s_iot_attr_db[] = {
    ...
    GATT_H_CHARACTERISTIC_USER_RSP(BT_FW_UUID_DECLARE_16(0xFF02), GATT_PROP_READ | GATT_PROP_WRITE_NR, GATT_PERM_READ | GATT_PERM_WRITE, rx_char_on_read, rx_char_on_write, IOT_SERVICE_RX_CHR_ID),
