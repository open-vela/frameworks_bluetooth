...
static gatt_attr_db_t s_dis_attr_db[] = {
    GATT_H_PRIMARY_SERVICE(BT_FW_UUID_DECLARE_16(0x180A), DIS_SERVICE_ID),
    GATT_H_CHARACTERISTIC_AUTO_RSP(BT_FW_UUID_DECLARE_16(0x2A24), GATT_PROP_READ, GATT_PERM_READ, (uint8_t*)model_number_str, sizeof(model_number_str), DIS_MODEL_NUMBER_CHR_ID),
    GATT_H_CHARACTERISTIC_AUTO_RSP(BT_FW_UUID_DECLARE_16(0x2A29), GATT_PROP_READ, GATT_PERM_READ, (uint8_t*)manufacturer_name_str, sizeof(manufacturer_name_str), DIS_MANUFACTURER_NAME_CHR_ID),
    GATT_H_CHARACTERISTIC_AUTO_RSP(BT_FW_UUID_DECLARE_16(0x2A50), GATT_PROP_READ, GATT_PERM_READ, (uint8_t*)pnp_id, sizeof(pnp_id), DIS_PNP_CHR_ID),
};
...
static gatt_attr_db_t s_bas_attr_db[] = {
    GATT_H_PRIMARY_SERVICE(BT_FW_UUID_DECLARE_16(0x180F), BAS_SERVICE_ID),
    GATT_H_CHARACTERISTIC_AUTO_RSP(BT_FW_UUID_DECLARE_16(0x2A19), GATT_PROP_READ | GATT_PROP_NOTIFY, GATT_PERM_READ, &battery_level, sizeof(battery_level), BAS_BATTERY_LEVEL_CHR_ID),
...
static gatt_attr_db_t s_iot_attr_db[] = {
    ...
    GATT_H_PRIMARY_SERVICE(BT_FW_UUID_DECLARE_16(0xFF00), IOT_SERVICE_ID),
    /* Private Characteristic for TX - 0xFF01 */
    GATT_H_CHARACTERISTIC_AUTO_RSP(BT_FW_UUID_DECLARE_16(0xFF01), GATT_PROP_NOTIFY | GATT_PROP_INDICATE, 0, NULL, 0, IOT_SERVICE_TX_CHR_ID),
    ...
    GATT_H_CHARACTERISTIC_USER_RSP(BT_FW_UUID_DECLARE_16(0xFF02), GATT_PROP_READ | GATT_PROP_WRITE_NR | GATT_PROP_WRITE, GATT_PERM_READ | GATT_PERM_WRITE, rx_char_on_read, rx_char_on_write, IOT_SERVICE_RX_CHR_ID),
    /* Private Characteristic for read operation demo - 0xFF05 */
    GATT_H_CHARACTERISTIC_AUTO_RSP(BT_FW_UUID_DECLARE_16(0xFF05), GATT_PROP_READ, GATT_PERM_READ, read_char_value, sizeof(read_char_value), IOT_SERVICE_READ_CHR_ID),
    /* PTS: MTU-1 Read characteristic - 0xFF06 */
    GATT_H_CHARACTERISTIC_AUTO_RSP(BT_FW_UUID_DECLARE_16(0xFF06), GATT_PROP_READ, GATT_PERM_READ, read_pts_char_value, sizeof(read_pts_char_value), IOT_SERVICE_PTS_MTU_CHR_ID),
    /* Private Characteristic for read and Signed write demo - 0xFF07 */
    GATT_H_CHARACTERISTIC_USER_RSP(BT_FW_UUID_DECLARE_16(0xFF07), GATT_PROP_READ | GATT_PROP_SIGNED_WRITE, GATT_PERM_READ | GATT_PERM_WRITE, rx_char_on_read, rx_char_on_write, IOT_SERVICE_SIGN_RW_CHR_ID),
    /* Private Characteristic for Auth R/W demo - 0xFF08 */
    GATT_H_CHARACTERISTIC_USER_RSP(BT_FW_UUID_DECLARE_16(0xFF08), GATT_PROP_READ | GATT_PROP_WRITE, GATT_PERM_READ | GATT_PERM_WRITE | GATT_PERM_AUTHEN_REQUIRED, rx_char_on_read, rx_char_on_write, IOT_SERVICE_AUTH_CHR_ID),
};
