...
static gatt_attr_db_t s_iot_attr_db[] = {
    ...
    GATT_H_CHARACTERISTIC_AUTO_RSP(BT_FW_UUID_DECLARE_16(0xFF05), GATT_PROP_READ, GATT_PERM_READ, read_only_char_value, sizeof(read_only_char_value), IOT_SERVICE_READ_CHR_ID),
    /* PTS: MTU-1 Read characteristic - 0xFF06 */
    GATT_H_CHARACTERISTIC_USER_RSP(BT_FW_UUID_DECLARE_16(0xFF06), GATT_PROP_READ, GATT_PERM_READ, rx_pts_char_on_read, NULL, IOT_SERVICE_PTS_MTU_CHR_ID),
