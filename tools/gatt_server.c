...
static int connect_cmd(void* handle, int argc, char* argv[])
{
    ...
    int service_id = strtol(argv[0], NULL, 10);
...
static int notify_bas_cmd(void* handle, int argc, char* argv[])
{
    ...
    int new_level = strtol(argv[1], NULL, 10);
...
static int update_phy_cmd(void* handle, int argc, char* argv[])
{
    ...
    int tx = strtol(argv[2], NULL, 10);
    int rx = strtol(argv[3], NULL, 10);
...
static int throughput_cmd(void* handle, int argc, char* argv[])
{
    ...
    int32_t test_time = strtol(argv[1], NULL, 10);
    if (test_time <= 0)
        return CMD_INVALID_OPT;
