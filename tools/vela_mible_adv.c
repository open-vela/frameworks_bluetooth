    ...
    while ((opt = getopt_long(argc, argv, "+t:m:i:n:a:p:c:f:d:P:T:O:R:D", adv_options,
        ...
        case 't':
            if (strncasecmp(optarg, "adv_ind", strlen("adv_ind")) == 0)
                params.options |= (BT_LE_ADV_OPT_SCANNABLE | BT_LE_ADV_OPT_CONN);
            else if (strncasecmp(optarg, "direct_ind", strlen("direct_ind")) == 0)
                params.options |= BT_LE_ADV_OPT_DIR_MODE_LOW_DUTY;
                ...
                params.options |= BT_LE_ADV_OPT_FILTER_SCAN_REQ;
            else {
        ...
        case 'p': {
            ...
            params.options |= BT_LE_PER_ADV_OPT_USE_TX_POWER;
        ...
        case 'c': {
            ...
            if (channel == 0)
                params.options |= ~(BT_LE_ADV_OPT_DISABLE_CHAN_37 | BT_LE_ADV_OPT_DISABLE_CHAN_38 | BT_LE_ADV_OPT_DISABLE_CHAN_39);
            else if (channel == 37)
                params.options |= ~BT_LE_ADV_OPT_DISABLE_CHAN_37;
            else if (channel == 38)
                params.options |= ~BT_LE_ADV_OPT_DISABLE_CHAN_38;
            else if (channel == 39)
                params.options |= ~BT_LE_ADV_OPT_DISABLE_CHAN_38;
        ...
        case 'f': {
            if (strncasecmp(optarg, "none", strlen("none")) == 0)
                params.options |= ~(BT_LE_ADV_OPT_FILTER_SCAN_REQ | BT_LE_ADV_OPT_FILTER_CONN);
        ...
        case 'P': {
            ...
            if (!params.peer) {
                params.peer = malloc(sizeof(bt_addr_le_t));
            }

            memcpy(&params.peer->a.val, peeraddr.addr, BT_ADDR_LENGTH);
