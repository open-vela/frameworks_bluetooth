...
static int connect_audio(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_connect_audio(handle, &addr, strtol(argv[1], NULL, 16)) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
...
static int discovery_member_start(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_discovery_member_start(handle, strtol(argv[0], NULL, 16)) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
...
static int discovery_member_stop(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_discovery_member_stop(handle, strtol(argv[0], NULL, 16)) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
...
static int group_add_member(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_group_add_member(handle, strtol(argv[0], NULL, 16), &addr) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
...
static int group_remove_member(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_group_remove_member(handle, strtol(argv[0], NULL, 16), &addr) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
...
static int group_connect_audio(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_group_connect_audio(handle, strtol(argv[0], NULL, 16), strtol(argv[1], NULL, 16)) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
...
static int group_disconnect_audio(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_group_disconnect_audio(handle, strtol(argv[0], NULL, 16)) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
...
static int group_lock(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_group_lock(handle, strtol(argv[0], NULL, 16)) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
...
static int group_unlock(void* handle, int argc, char* argv[])
{
    ...
    if (bt_lea_client_group_unlock(handle, strtol(argv[0], NULL, 16)) != BT_STATUS_SUCCESS)
        return CMD_ERROR;
