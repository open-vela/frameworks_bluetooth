...
{
    PRINT("cs distance measure result. cookie:%p, addr:%s, centimeter:%d, errorCentimeter:%d, azimuthAngle:%d, errorAzimuthAngle:%d, altitudeAngle:%d, errorAltitudeAngle:%d, elapsedRealtimeNanos:%ld, confidenceLevel:%d, delaySpreadMeters:%lf, detectedAttackLevel:%d, velocityMetersPerSecond:%lf, method:%d\n",
